      ...
      <div className={`container ${styles.contactContainer}`}>
        ...
        <div className={styles.leftPanel}>
          ...
          <div className={styles.addressBox}>
            ...
            <p>📧 Email: <a href="mailto:milesalongsmiles@gmail.com" style={{ color: 'inherit', textDecoration: 'none', borderBottom: '1px solid currentColor' }}>milesalongsmiles@gmail.com</a></p>
          </div>
        ...
        <div className={styles.rightPanel}>
          ...
          {isSubmitted ? (
            <div className={styles.successMessage}>
              <h2>Thank You! 🎉</h2>
              <p>Your message has been initiated via WhatsApp.</p>
              <button onClick={() => setIsSubmitted(false)} className={`${styles.btnSubmit} ${styles.btnSuccess}`}>Send Another</button>
            </div>
          ) : (
